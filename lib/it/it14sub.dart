...
class It14sub extends StatefulWidget {
  @override
  _It14subState createState() => _It14subState();
}

class _It14subState extends State<It14sub> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new It14sis();}));
                  },
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new It14sdp();}));
                ...
                RaisedButton(
                  ...
                  child: Ink(
                    ...
                    child: Container(
                      ...
                      child:  Text(
                        'Wireless Networks\n& Mobile Computing',
                        textAlign: TextAlign.center, style: TextStyle(fontSize: ScreenUtil.instance.setSp(25.0), color: Colors.white.withOpacity(0.7)) ,
                      ),
                    ),
                  ),
                )
