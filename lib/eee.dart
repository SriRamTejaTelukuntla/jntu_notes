...
import 'eee/eee11sub.dart';
import 'eee/eee12sub.dart';
import 'eee/eee13sub.dart';
import 'eee/eee14sub.dart';
import 'main.dart';
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "\n"),
                  TextSpan(text: "Electrical & Electronics Engineering" , style: TextStyle(
                      fontFamily: 'ProductSans',
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new Eee14sub();}));
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new Eee13sub();}));
                  },
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                  padding: const EdgeInsets.all(0.0),
                  child: Ink(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new Eee12sub();}));
                  },
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                  padding: const EdgeInsets.all(0.0),
                  child: Ink(
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                ...
                RaisedButton(
                  onPressed: () {
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new Eee11sub();}));
                  },
                  shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10.0)),
                  padding: const EdgeInsets.all(0.0),
                  child: Ink(
                    decoration:  BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Colors.deepPurple.shade300,Colors.pinkAccent.shade100,
                          // Color(0xFFff9214),
                          //Color(0xFFffba7a),
                        ],
                        begin: Alignment.bottomLeft,
