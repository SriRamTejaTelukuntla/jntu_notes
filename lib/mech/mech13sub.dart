...
class Mech13sub extends StatefulWidget {
  @override
  _Mech13subState createState() => _Mech13subState();
}

class _Mech13subState extends State<Mech13sub> {
                  ...
                  child: Ink(
                    decoration:  BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Color(0xFF329D9C), Color(0xFF7BE495),                          //Color(0xFFffba7a),
                        ],
