...
import 'package:notes/it/itpdf.dart';
import '../HomePage.dart';
import '../my_flutter_app_icons.dart';
import 'it14sub.dart';

class It14sis extends StatefulWidget {


  @override
  _It14sisState createState() => _It14sisState();
}

class _It14sisState extends State<It14sis> {
          ...
          Padding(
            ...
            child: Row(
              ...
              children: <Widget>[
                RaisedButton(
                  onPressed: (){
                    Navigator.of(context).push(MaterialPageRoute<Null>(builder: (BuildContext context) {return new ItPdf();}));
                  },
