...
class Civi113sub extends StatefulWidget {
  @override
  _Civil13subState createState() => _Civil13subState();
}

class _Civil13subState extends State<Civi113sub> {
            ...
            child: Row(
              ...
              children: <Widget>[
                IconButton(
                  ...
                  color: Color(0xFFF73390),                  onPressed: () {
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "\n"),
                  TextSpan(text: "III-Year  I-Semister" , style: TextStyle(
                      fontFamily: 'ProductSans',
