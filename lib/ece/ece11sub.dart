...
class Ece11sub extends StatefulWidget {
  @override
  _Ece11subState createState() => _Ece11subState();
}

class _Ece11subState extends State<Ece11sub> {
    ...
    return Scaffold(
      ...
      body: ListView(
        children: <Widget>[
              ...
              text: TextSpan(
                children: [
                  TextSpan(text: "ECE" , style: TextStyle(
                      ...
                      fontSize: ScreenUtil.instance.setHeight(60.0),)
          ...
          SizedBox(height: ScreenUtil.instance.setSp(40.0),),
          Padding(
                  ...
                  child: Ink(
                    decoration:  BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Color(0xFF7367F0),Color(0xFFCE9FFC),//Color(0xFFffba7a),
                        ],
