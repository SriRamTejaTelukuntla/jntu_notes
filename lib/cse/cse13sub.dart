...
class Cse13sub extends StatefulWidget {
  @override
  _Cse13subState createState() => _Cse13subState();
}

class _Cse13subState extends State<Cse13sub> {
                  ...
                  child: Ink(
                    decoration:  BoxDecoration(
                      gradient: LinearGradient(
                        colors: [
                          Colors.deepOrange.shade400,Colors.orange.shade200,           //Color(0xFFffba7a),
                        ],
