...
class It12sub extends StatefulWidget {
  @override
  _It12subState createState() => _It12subState();
}

class _It12subState extends State<It12sub> {
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "\n"),
                  TextSpan(text: "II-Year  I-Semister" , style: TextStyle(
                      fontFamily: 'ProductSans',
