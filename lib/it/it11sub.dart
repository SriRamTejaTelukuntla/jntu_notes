...
class It11sub extends StatefulWidget {
  @override
  _It11subState createState() => _It11subState();
}

class _It11subState extends State<It11sub> {
            ...
            child: RichText(
              text: TextSpan(
                children: [
                  ...
                  TextSpan(text: "\n"),
                  TextSpan(text: "I-Year  I-Semister" , style: TextStyle(
                      fontFamily: 'ProductSans',
              ...
              children: <Widget>[
                RaisedButton(
                  ...
                  child: Ink(
                    ...
                    child: Container(
                      height: ScreenUtil.instance.setHeight(60.0),
                      width: ScreenUtil.instance.setWidth(3000.0),
                      alignment: Alignment.center,
                      child:  Text(
                        'Wireless Networks\n& Mobile Computing',
